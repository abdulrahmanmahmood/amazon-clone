  ...
  return (
    ...
    <div className="home">
      ...
      <div>
        ...
        <img class="d-block w-100" src={homeImg2} alt="First slide" />
          </label><label htmlFor="spades">
          <img class="d-block w-100" src={homeImg3} alt="First slide" />
            </label><label htmlFor="diamonds">♦ Diamonds</label>
