      ...
      <table role="presentation" bgcolor="#ffffff" width="100%" style="max-width:600px;border: solid 1px #d0d0d0" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top" align="center">
            ...
            <table border={0} cellPadding={0} cellSpacing={0} width="100%" role="presentation">
        <tbody><tr>
            <td align="left" className="center" style={{padding: '30px 20px'}}>
              <p style={{color: '#77787b', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '13px', lineHeight: '19px', margin: 0}} tabIndex={0}>
